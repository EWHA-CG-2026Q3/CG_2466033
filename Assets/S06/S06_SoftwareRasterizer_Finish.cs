...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(55, 210);
    [SerializeField] private Vector2 vertexB = new Vector2(30, 45);
    [SerializeField] private Vector2 vertexC = new Vector2(225, 90);
    [SerializeField] private Color fillColor = new Color(0.4f, 0.8f, 1f, 1f);
